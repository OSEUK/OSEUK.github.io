const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-800 mt-12 transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              A personal blog sharing thoughts, ideas, and experiences.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/tags" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Tags
                </a>
              </li>
              <li>
